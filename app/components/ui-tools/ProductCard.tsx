    ...
    <Card className="relative p-0 border-none rounded-none shadow-none w-full">
        <CardHeader className="relative">
            ...
            <div className="relative overflow-clip">
                ...
                <Image src={ModelImage} alt={"Image"} width={800} height={500} className="hover:scale-110"/>
                <p className="absolute bottom-0 w-full bg-white text-center border-black border-[1px] text-sm py-2 hover:bg-black hover:text-white font-semibold">QUICK ADD</p>
            </div>
        ...
        <CardFooter>
            <div className="flex flex-row items-center justify-center w-full">
                <div className="border-2 border-red-900 flex items-center  rounded-full justify-center m-1">
                    <Badge variant={"outline"} className="relative p-0 w-8 h-8 rounded-full">
                    <Image src={ModelImage} alt={"Image"} layout="fill" objectFit="cover" className="absolute w-full h-full p-0 rounded-full overflow-hidden"/>
                    </Badge>
                </div>
                <div className="border-2 border-red-900 flex items-center  rounded-full justify-center m-1">
                    <Badge variant={"outline"} className="relative p-0 w-8 h-8 rounded-full">
